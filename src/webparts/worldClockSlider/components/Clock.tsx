...
{ 
    ...
    { 
        ...
        { 
            ...
            strAnchorTags.push(<a className="AnchoreTag"  target="_blank"  href={strOfficeLink}> <p className="ClockTitle">
                ...
                { 
                    objTimeVal = <a className="AnchorTag" target="_blank"> <div className={styleDigitalCSS}> 
                    {<div className="clockDate">{escape(this.state.date.toLocaleTimeString([],{hour:'2-digit',hour12:this.props.HoursFormat}))}</div>}
