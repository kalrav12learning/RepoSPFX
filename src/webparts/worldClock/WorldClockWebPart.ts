...
export default class WorldClockWebPart extends BaseClientSideWebPart<IWorldClockWebPartProps> {
  ...
  protected async onInit():Promise<void> { 
    ...
    { 
      ...
      { 
        ...
        await this.context.httpClient.get("https://newlearning12.sharepoint.com/sites/Development/Assets/WMCentralStyle.css?v=" + versionUpdate,SPHttpClient.configurations.v1);
        SPComponentLoader.loadCss( "https://newlearning12.sharepoint.com/sites/Development/Assets/WMCentralStyle.css?v="+ versionUpdate);
     
        SPComponentLoader.loadCss( "https://newlearning12.sharepoint.com/sites/Development/Assets/slick.min.css?v="+ versionUpdate);
     SPComponentLoader.loadCss( "https://newlearning12.sharepoint.com/sites/Development/Assets/slick-theme.min.css?v="+ versionUpdate);
      }
 ...
 { 
   ...
   let objList : any; 
   let web; 
   let siteCollectionUrl = this.context.pageContext.site.absoluteUrl.replace(this.context.pageContext.site.serverRelativeUrl,"") + "/sites/Development";
